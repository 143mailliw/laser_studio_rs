...
pub fn update_graphical_workspace(ctx: &egui::Context, app: &mut super::LaserStudioApp) {
    ...
    egui::CentralPanel::default().show(ctx, |ui| {
        ...
        egui::containers::Area::new("Tools").fixed_pos(egui::Pos2::new(4.0, 35.0)).show(ctx, |ui| {
            ...
            ui.group(|ui| {
                ...
                let mut pencil = ui.selectable_label(curr_tool == Tools::Pencil, egui::RichText::new("✏").text_style(egui::TextStyle::Monospace).size(15.0));
                let mut eraser = ui.selectable_label(curr_tool == Tools::Eraser, egui::RichText::new("❌").text_style(egui::TextStyle::Monospace).size(15.0));
                let mut filler = ui.selectable_label(curr_tool == Tools::PaintBucket, egui::RichText::new("🌋").text_style(egui::TextStyle::Monospace).size(15.0));
                let mut picker = ui.selectable_label(curr_tool == Tools::ColorPicker, egui::RichText::new("🌋").text_style(egui::TextStyle::Monospace).size(15.0));
